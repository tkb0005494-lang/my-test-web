...
const FORM_FIELDS = { name: 'entry.1711447572', uni: 'entry.651877505', dept: 'entry.1169658860', phone: 'entry.1253545059', grade: 'entry.247937200' };
...
const ALL_QUIZ_DATA = [
    ...
    { subject: "線性代數", topic: "線性映射", question: "核空間映射後必為？", answerOptions: [{ text: "零向量", isCorrect: true, rationale: "定義。" }, { text: "單位向量", isCorrect: false, rationale: "錯。" }, { text: "自己", isCorrect: false, rationale: "錯。" }, { text: "不存在", isCorrect: false, rationale: "錯。" }] },
    // 計算機概論
    ...
    { subject: "計算機概論", topic: "OS", question: "何者負責管理硬體資源？", answerOptions: [{ text: "作業系統", isCorrect: true, rationale: "核心功能。" }, { text: "編譯器", isCorrect: false, rationale: "轉譯用。" }, { text: "瀏覽器", isCorrect: false, rationale: "應用層。" }, { text: "資料庫", isCorrect: false, rationale: "存儲用。" }] },
    ...
    { subject: "計算機概論", topic: "語言", question: "何者為低階語言？", answerOptions: [{ text: "組合語言", isCorrect: true, rationale: "正確。" }, { text: "Python", isCorrect: false, rationale: "高階。" }, { text: "Java", isCorrect: false, rationale: "高階。" }, { text: "C++", isCorrect: false, rationale: "中高階。" }] },
    // 經濟學
    { subject: "經濟學", topic: "需求", question: "所得增加導致需求減少的商品？", answerOptions: [{ text: "劣等財", isCorrect: true, rationale: "定義。" }, { text: "正常財", isCorrect: false, rationale: "增加。" }, { text: "季芬財", isCorrect: false, rationale: "價格向。" }, { text: "奢侈品", isCorrect: false, rationale: "正常財。" }] },
    { subject: "經濟學", topic: "生產", question: "邊際報酬遞減發生在？", answerOptions: [{ text: "短期", isCorrect: true, rationale: "要素固定時。" }, { text: "長期", isCorrect: false, rationale: "變動規模。" }, { text: "永遠", isCorrect: false, rationale: "錯。" }, { text: "市場崩盤", isCorrect: false, rationale: "錯。" }] },
    { subject: "經濟學", topic: "GDP", question: "實質 GDP 排除何種影響？", answerOptions: [{ text: "物價變動", isCorrect: true, rationale: "採用基期。" }, { text: "人口", isCorrect: false, rationale: "那是平均。" }, { text: "進出口", isCorrect: false, rationale: "計入。" }, { text: "政府支出", isCorrect: false, rationale: "計入。" }] },
    { subject: "經濟學", topic: "市場", question: "寡占市場的特徵是？", answerOptions: [{ text: "廠商相互依賴", isCorrect: true, rationale: "決策互相影響。" }, { text: "單一生產者", isCorrect: false, rationale: "獨佔。" }, { text: "產品同質", isCorrect: false, rationale: "不一定。" }, { text: "進出自由", isCorrect: false, rationale: "完全競爭。" }] },
    { subject: "經濟學", topic: "政策", question: "央行調升利率會？", answerOptions: [{ text: "抑制通膨", isCorrect: true, rationale: "減少貨幣量。" }, { text: "促進消費", isCorrect: false, rationale: "抑制。" }, { text: "台幣貶值", isCorrect: false, rationale: "升值。" }, { text: "股市大漲", isCorrect: false, rationale: "利空。" }] },
    // 微積分
    { subject: "微積分", topic: "微分", question: "$\ln(x)$ 的導數？", answerOptions: [{ text: "$1/x$", isCorrect: true, rationale: "公式。" }, { text: "$e^x$", isCorrect: false, rationale: "錯。" }, { text: "$x$", isCorrect: false, rationale: "錯。" }, { text: "1", isCorrect: false, rationale: "錯。" }] },
    ...
    { subject: "微積分", topic: "極限", question: "L'Hopital 法則適用於？", answerOptions: [{ text: "$0/0$ 型", isCorrect: true, rationale: "不定型。" }, { text: "$1/0$ 型", isCorrect: false, rationale: "錯。" }, { text: "$0 \times 1$", isCorrect: false, rationale: "須先轉。" }, { text: "所有函數", isCorrect: false, rationale: "錯。" }] },
    ...
    { subject: "微積分", topic: "多變量", question: "鞍點 (Saddle point) 是？", answerOptions: [{ text: "非極大極小臨界點", isCorrect: true, rationale: "正確。" }, { text: "絕對極值", isCorrect: false, rationale: "錯。" }, { text: "轉折點", isCorrect: false, rationale: "錯。" }, { text: "不存在", isCorrect: false, rationale: "錯。" }] },
    // 統計學
    { subject: "統計學", topic: "分佈", question: "哪種分佈具「無記憶性」？", answerOptions: [{ text: "指數分佈", isCorrect: true, rationale: "正確。" }, { text: "常態", isCorrect: false, rationale: "無。" }, { text: "二項", isCorrect: false, rationale: "無。" }, { text: "卜瓦松", isCorrect: false, rationale: "無。" }] },
    { subject: "統計學", topic: "誤差", question: "信心水準越高，信賴區間長度會？", answerOptions: [{ text: "變長", isCorrect: true, rationale: "擴大寬容度。" }, { text: "變短", isCorrect: false, rationale: "錯。" }, { text: "不變", isCorrect: false, rationale: "錯。" }, { text: "歸零", isCorrect: false, rationale: "錯。" }] },
    { subject: "統計學", topic: "檢定", question: "P值小於 $\alpha$ 時？", answerOptions: [{ text: "拒絕 $H_0$", isCorrect: true, rationale: "顯著。" }, { text: "不拒絕", isCorrect: false, rationale: "大於才是不拒絕。" }, { text: "數據錯", isCorrect: false, rationale: "無關。" }, { text: "接受 $H_1$", isCorrect: true, rationale: "對。" }] },
    { subject: "統計學", topic: "相關", question: "$r= -0.9$ 代表？", answerOptions: [{ text: "高度負相關", isCorrect: true, rationale: "接近-1。" }, { text: "低度正相關", isCorrect: false, rationale: "錯。" }, { text: "無相關", isCorrect: false, rationale: "0才是無。" }, { text: "因果", isCorrect: false, rationale: "非因果。" }] },
    { subject: "統計學", topic: "抽樣", question: "中心極限定理要求 $n$ 至少大於？", answerOptions: [{ text: "30", isCorrect: true, rationale: "經驗值。" }, { text: "100", isCorrect: false, rationale: "太多。" }, { text: "5", isCorrect: false, rationale: "太少。" }, { text: "無限大", isCorrect: false, rationale: "錯。" }] }
];

const STUDY_PLANS = {
    "工程數學": ["複習一階 ODE、二階線性齊次、非齊次求解公式，掌握特徵方程根的判別。", "攻克拉普拉斯轉換 (Laplace Transform) 基本定義、平移定理與卷積原理。", "深入傅立葉級數 (Fourier Series) 與積分展開，釐清奇偶函數的係數特性。", "強化矩陣運算、特徵值 (Eigenvalue) 與線性方程組的空間解結構。"],
    "線性代數": ["鞏固向量空間 (Vector Space) 子空間判定與線性獨立 (LI) 的基本功。", "掌握基底變換、線性映射 (Linear Transformation) 的核空間與對應矩陣。", "實作 Gram-Schmidt 正交化程序，理解投影矩陣與最小平方法應用。", "對角化 (Diagonalization) 與特徵分解，熟悉對稱矩陣必可交對角化特性。"],
    "計算機概論": ["掌握進位轉換、補數運算、IEEE 754 浮點數表示法等數位資料基礎。", "深入理解 CPU 排程 (Scheduling)、記憶體分頁機制與死鎖 (Deadlock) 預防。", "複習 OSI 七層模型、TCP/UDP 差異、HTTP 協議與網路安全基礎。", "掌握常用資料結構 (Stack, Queue, Tree, Hash) 的時間複雜度分析與演算法。"],
    "經濟學": ["釐清個體經濟：需求彈性、消費者行為理論 (無異曲線) 與效用極大化。", "深入廠商理論：四大市場結構 (完全競爭、壟斷、寡占、壟斷競爭) 的定價行為。", "總體經濟核心：國民所得計算、IS-LM 模型與總合供需 (AD-AS) 模型分析。", "理解財政政策與貨幣政策工具，分析通膨、失業與經濟成長的連動關係。"],
    "微積分": ["精通導數基本公式、鏈鎖律、隱函數微分與均值定理 (MVT) 應用。", "掌握積分技巧 (代換積分、分部積分、部分分式) 與定積分基本定理。", "理解多變量函數偏微分、全微分與拉格朗日乘數法 (Lagrange Multipliers)。", "攻克無窮級數收斂檢定 (比值、根號、積分檢定法) 與泰勒展開式。"],
    "統計學": ["複習機率論基礎：條件機率、貝氏定理與常用間斷/連續機率分佈特性。", "掌握抽樣分佈、點估計與區間估計 (Confidence Interval) 的推導與邏輯。", "深入假設檢定 (Hypothesis Testing)：Z/t/F 檢定與 P-value 判斷標準。", "練習簡單線性迴歸分析、相關係數計算與變異數分析 (ANOVA) 基礎應用。"]
};

const VIDEO_LINKS = { "工程數學": "LiW8jvHZ7o4", "線性代數": "dW4cUVU089Q", "計算機概論": "ZC98Wmrtb7o", "經濟學": "2ZXmDGBC4c4", "微積分": "QNLL0qfEPmI", "統計學": "GhAxVkA1He8" };

let currentSubject = '', currentScore = 0, answeredCount = 0, currentQuizList = [];
...
function startQuiz() {
    ...
    currentQuizList.forEach((q, idx) => {
        ...
        div.innerHTML = `<div><strong>Q${idx+1}. ${q.question}</strong></div>
            <div class="opt-box" data-qidx="${idx}">${q.answerOptions.map((opt, i) => `<div class="option-item" onclick="handleSelect(this, ${idx}, ${i})">${String.fromCharCode(65+i)}. ${opt.text}</div>`).join('')}</div>
...
function handleSelect(el, qIdx, oIdx) {
    ...
    if (correct) currentScore += 20;
    else box.querySelectorAll('.option-item')[currentQuizList[qIdx].answerOptions.findIndex(o => o.isCorrect)].classList.add('correct');
    ...
    answeredCount++;
    if (answeredCount === 5) setTimeout(finishQuiz, 1000);
}
...
document.getElementById('goToResourceBtn').onclick = function() {
    ...
    document.getElementById('youtubePlayer').innerHTML = `<iframe src="https://www.youtube.com/embed/${VIDEO_LINKS[currentSubject]}" allowfullscreen></iframe>`;
    const plan = STUDY_PLANS[currentSubject];
    for (let i = 1; i <= 4; i++) document.getElementById(`plan-week-${i}`).innerText = plan[i-1];
